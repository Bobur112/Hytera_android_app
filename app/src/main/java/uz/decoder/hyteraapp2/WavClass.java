...
public class WavClass {
    ...
    public String getTempWavFile() {
        return getPath(tempWavFile);
    }

    public void setTempWavFile(String tempWavFile) {
    ...
    public int getShovqintf() {
        return shovqintf;
    }

    public void setShovqintf(int shovqintf) {
        this.shovqintf = shovqintf;
    }

    private int shovqintf = 1;
    ...
    public void stopRecording(){
        try{
            if(recorder != null) {
                ...
                try {
                    m_proc = new MorseProcessor(new File(getPath(tempWavFile)));
                    m_proc.setSHOVQIN(shovqintf);
                    m_proc.process();
